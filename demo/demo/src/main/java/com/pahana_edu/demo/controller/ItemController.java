...
public class ItemController {
    ...
    @PostMapping("/additem")
    public String saveItem(@RequestBody ItemDTO itemDTO) {
        // itemCode will be generated automatically
        itemDTO.setItemCode(null); // explicitly clear any input code to avoid confusion
        itemService.saveItem(itemDTO);
        return "Item added successfully!";
    }
 ...
 * public String saveItem(@RequestBody ItemDTO itemDTO) {
 * // itemCode will be generated automatically
 * itemDTO.setItemCode(null); // explicitly clear any input code to avoid
 * confusion
 * itemService.saveItem(itemDTO);
 * return "Item added successfully!";
 * }
 * 
 * @PatchMapping("/updateitem/{id}")
 * public String updateItem(@PathVariable String id, @RequestBody ItemDTO
 * itemDTO) {
 * itemDTO.setItemCode(id); // set itemId from path variable
 * itemService.updateItem(itemDTO);
 * return "Item updated successfully!";
